...
CREATE CLUSTERED INDEX [IX_sales_price_item_no_variant_code] ON [dbo].[sales_price_current] ([item_no],[variant_code])
ON [FLOWBYTE_SALES];

GO


CREATE INDEX [IX_sales_price_company_id] ON [dbo].[sales_price_current] ([company_id])

GO

CREATE INDEX [IX_sales_price_sales_code] ON [dbo].[sales_price_current] ([sales_code])
